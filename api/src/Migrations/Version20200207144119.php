 ...
 */
final class Version20200207144119 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE offer (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, guid CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', price DOUBLE PRECISION NOT NULL, buying TINYINT(1) NOT NULL, name VARCHAR(255) NOT NULL, max_num_wanted INT NOT NULL, store_id VARCHAR(255) NOT NULL, store_name LONGTEXT NOT NULL, currency_name VARCHAR(255) NOT NULL, user_name VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, INDEX IDX_29D6873EA76ED395 (user_id), INDEX idx_item_name (name, user_name), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
