 ...
 */
final class Version20200203201256 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE server (id INT AUTO_INCREMENT NOT NULL, external_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:guid)\', name VARCHAR(255) NOT NULL, export_last_process DATETIME DEFAULT NULL, version VARCHAR(255) DEFAULT NULL, time_left INT DEFAULT NULL, time_since_start INT DEFAULT NULL, online_players INT DEFAULT NULL, total_players INT DEFAULT NULL, description VARCHAR(255) DEFAULT NULL, detailed_description VARCHAR(255) DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
